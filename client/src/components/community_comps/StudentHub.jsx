                ...
                <div className="flex flex-col gap-2 relative w-full">
                    ...
                    <div className="flex items-center gap-1.5 min-[426px]:gap-2 relative w-full bg-gray-50 rounded-[24px] min-[426px]:rounded-[28px] border border-gray-100 p-1.5 shadow-sm focus-within:ring-2 focus-within:ring-[#0F172A]/20 transition-all">
                        ...
                        <div className="relative">
                            ...
                            {showMediaPicker && <div className="absolute bottom-full mb-2 z-50 left-0 min-[426px]:left-0" style={{right: 'auto', maxWidth: 'calc(100vw - 32px)'}}><ChatMediaPicker hideGifs={currentUser?.role === 'teacher'} onGifSelect={(gif) => { setSelectedGif(gif); setShowMediaPicker(false); }} onEmojiSelect={(e) => setChatInput(p => p + e)} onClose={() => setShowMediaPicker(false)} /></div>}
                        </div>
                        </div>
