        ...
        >
          ...
          <div className={`relative z-10 flex flex-col flex-1 h-screen overflow-hidden transition-all duration-300 ml-0 sm:ml-28 ${collapsed ? 'lg:ml-28' : 'lg:ml-64'}`}>
            ...
            <div className="flex-1 px-4 sm:px-6 pb-6 overflow-hidden flex flex-col">
              ...
              <div className="flex-1 min-h-0 overflow-y-auto no-scrollbar w-full flex flex-col pb-16 sm:pb-0">
                <Outlet />
              </div>
            </div>
          </div>
          ...
          <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-50 glass-panel border-t border-white/60 flex items-center justify-around pb-safe">
            {isCommunity ? (
              <>
                <a href="/student/community" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                ...
                <a href="/student/community/classroom" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="m23,24h-5c-.4,0-.761-.238-.919-.605s-.082-.794.194-1.084c.792-.833,1.967-1.311,3.225-1.311s2.433.478,3.225,1.311c.276.29.352.717.194,1.084s-.519.605-.919.605Zm-7.581-.605c.158-.367.082-.794-.194-1.084-.792-.833-1.967-1.311-3.225-1.311s-2.433.478-3.225,1.311c-.276.29-.352.717-.194,1.084s.519.605.919.605h5c.4,0,.761-.238.919-.605Zm-8.5,0c.158-.367.082-.794-.194-1.084-.792-.833-1.967-1.311-3.225-1.311s-2.433.478-3.225,1.311c-.276.29-.352.717-.194,1.084s.519.605.919.605h5c.4,0,.761-.238.919-.605Zm-3.419-3.395c1.105,0,2-.895,2-2s-.895-2-2-2-2,.895-2,2,.895,2,2,2Zm8.5,0c1.105,0,2-.895,2-2s-.895-2-2-2-2,.895-2,2,.895,2,2,2Zm8.5,0c1.105,0,2-.895,2-2s-.895-2-2-2-2,.895-2,2,.895,2,2,2Z"/></svg>
                  Classroom
                </a>
                <a href="/student/community/groups" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="m7.5 13a4.5 4.5 0 1 1 4.5-4.5 4.505 4.505 0 0 1 -4.5 4.5zm6.5 11h-13a1 1 0 0 1 -1-1v-.5a7.5 7.5 0 0 1 15 0v.5a1 1 0 0 1 -1 1zm3.5-15a4.5 4.5 0 1 1 4.5-4.5 4.505 4.505 0 0 1 -4.5 4.5zm-1.421 2.021a6.825 6.825 0 0 0 -4.67 2.831 9.537 9.537 0 0 1 4.914 5.148h6.677a1 1 0 0 0 1-1v-.038a7.008 7.008 0 0 0 -7.921-6.941z"/></svg>
                  Groups
                </a>
                <a href="/student/community/study-materials" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="M4.395,16.061c.199-.041,.402-.061,.605-.061h1V.1C3.672,.575,2,2.624,2,5v12.025c.699-.527,1.525-.86,2.395-.964Zm17.605,1.939H5c-1.657,0-3,1.343-3,3s1.343,3,3,3h12c2.761,0,5-2.239,5-5v-1Zm0-13v11H8V0h5V10.348c0,.623,.791,.89,1.169,.395l1.331-1.743,1.331,1.743c.378,.495,1.169,.228,1.169-.395V.101c2.282,.463,4,2.48,4,4.899Z"/></svg>
                  Materials
                </a>
              ...
              <>
                <a href="/student/home" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="m9,9H2c-1.103,0-2-.897-2-2v-2C0,2.243,2.243,0,5,0h4c1.103,0,2,.897,2,2v5c0,1.103-.897,2-2,2Zm10,15h-4c-1.103,0-2-.897-2-2v-5c0-1.103.897-2,2-2h7c1.103,0,2,.897,2,2v2c0,2.757-2.243,5-5,5Zm3-11h-7c-1.103,0-2-.897-2-2V2c0-1.103.897-2,2-2h4c2.757,0,5,2.243,5,5v6c0,1.103-.897,2-2,2Zm-13,11h-4c-2.757,0-5-2.243-5-5v-6c0-1.103.897-2,2-2h7c1.103,0,2,.897,2,2v9c0,1.103-.897,2-2,2Z"/></svg>
                  Dashboard
                </a>
                <a href="/student/todo" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current"><path d="m13.27 7.48c-.813.813-1.27 1.915-1.27 3.065v.955c0 .276.224.5.5.5h.955c1.149 0 2.252-.457 3.064-1.269l6.715-6.715c.85-.85 1.013-2.236.252-3.167-.875-1.07-2.456-1.129-3.409-.176zm4.664 4.664c-1.195 1.196-2.786 1.855-4.479 1.855h-1.455c-1.104 0-2-.896-2-2v-1.455c0-1.692.659-3.282 1.855-4.479l5.468-5.466c-.697-.37-1.48-.599-2.323-.599h-10c-2.757 0-5 2.243-5 5v14c0 2.757 2.243 5 5 5h10c2.757 0 5-2.243 5-5v-8.921l-2.066 2.066z"/></svg>
                  To-dos
                </a>
                <a href="/student/notes" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
                  <svg viewBox="0 0 512 512" className="w-5 h-5 fill-current"><path d="M320,170.667h139.52c-7.448-19.736-19.019-37.656-33.941-52.565l-74.325-74.368c-14.927-14.905-32.852-26.468-52.587-33.92v139.52C298.667,161.115,308.218,170.667,320,170.667z"/><path d="M468.821,213.333H320c-35.346,0-64-28.654-64-64V0.512C252.565,0.277,249.131,0,245.653,0h-96.32C90.452,0.071,42.737,47.786,42.667,106.667v298.667C42.737,464.214,90.452,511.93,149.333,512h213.333c58.881-0.07,106.596-47.786,106.667-106.667V223.68C469.333,220.203,469.056,216.768,468.821,213.333z"/></svg>
                  Notes
                </a>
                <a href="/student/studybot" className="flex flex-col items-center gap-0.5 py-2 px-3 text-gray-500 hover:text-green-600 text-[10px] font-medium">
