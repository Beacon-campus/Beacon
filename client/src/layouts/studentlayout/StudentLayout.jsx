  ...
  return (
    <>
      ...
      >
        ...
        <div className="max-[768px]:flex hidden fixed bottom-0 left-0 right-0 z-[70] bg-white border-t border-gray-200 px-2 sm:px-6 py-2 justify-around items-center shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
          ...
          <Link to="/student/profile" className="relative -top-3 glass-panel p-1 rounded-full shadow-md border border-gray-100 flex items-center justify-center transition-transform hover:scale-105 active:scale-95">
