      ...
      >
          ...
          <div className="flex flex-col h-full">
              ...
              <nav className="space-y-2 flex-1 overflow-y-auto no-scrollbar">
                {isCommunity ? (
                  // Community Links
                  <>
                    <NavLink to="/teacher/community" end className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                    ...
                    <NavLink to="/teacher/community/classrooms" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/community/groups" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/community/publish-assignment" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/community/upload-materials" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                  ...
                  // Home Links
                  <>
                    <NavLink to="/teacher/home" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/todo" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/notes" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                    ...
                    <NavLink to="/teacher/sketch" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/calender" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/researchbot" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
                    ...
                    <NavLink to="/teacher/notif" className={({ isActive }) => `flex items-center gap-3 p-2.5 rounded-[14px] transition-all duration-300 ${isActive ? "bg-green-50 text-green-700 shadow-sm border border-green-100/50" : "text-gray-600 hover:bg-white/50 border border-transparent"}`}>
                      {({ isActive }) => (
                        <>
                          <div className="w-5 h-5 flex items-center justify-center shrink-0">
                            <svg viewBox="0 0 24 24" className={getIconClass(isActive)}>
        ...
        <div className="max-[768px]:flex hidden fixed bottom-0 left-0 right-0 z-[70] bg-white border-t border-gray-200 px-2 sm:px-6 py-2 flex justify-around items-center shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)]">
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 transition-colors px-4 py-1 max-[425px]:px-2 ${mobileTab === 'home' || (!mobileMenuOpen && !isCommunity) ? 'text-green-600' : 'text-gray-500 hover:text-gray-800'}`}
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 max-[425px]:w-5 max-[425px]:h-5 fill-current">
              <path d="m9,9H2c-1.103,0-2-.897-2-2v-2C0,2.243,2.243,0,5,0h4c1.103,0,2,.897,2,2v5c0,1.103-.897,2-2,2Zm10,15h-4c-1.103,0-2-.897-2-2v-5c0-1.103.897-2,2-2h7c1.103,0,2,.897,2,2v2c0,2.757-2.243,5-5,5Zm3-11h-7c-1.103,0-2-.897-2-2V2c0-1.103.897-2,2-2h4c2.757,0,5,2.243,5,5v6c0,1.103-.897,2-2,2Zm-13,11h-4c-2.757,0-5-2.243-5-5v-6c0-1.103.897-2,2-2h7c1.103,0,2,.897,2,2v9c0,1.103-.897,2-2,2Z" />
            </svg>
            <span className="text-[10px] max-[425px]:text-[8px] font-bold">Home</span>
          </button>
          
          <Link to="/teacher/profile" className="relative -top-3 glass-panel p-1 rounded-full shadow-md border border-gray-100 flex items-center justify-center transition-transform hover:scale-105 active:scale-95">
          ...
          <button 
            ...
            className={`flex flex-col items-center gap-1 transition-colors px-4 py-1 max-[425px]:px-2 ${mobileTab === 'community' || (!mobileMenuOpen && isCommunity) ? 'text-green-600' : 'text-gray-500 hover:text-gray-800'}`}
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6 max-[425px]:w-5 max-[425px]:h-5 fill-current">
            ...
            <span className="text-[10px] max-[425px]:text-[8px] font-bold">Community</span>
          </button>
        </div>
      </div>
    </>
